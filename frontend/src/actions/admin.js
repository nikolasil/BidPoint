...
export const loginAdminUser = (formData) => async (dispatch) => {
  ...
  try {
    ...
    dispatch({
      type: types.LOGIN_ADMIN_USER_FAILURE,
...
export const loadAdminUser = () => async (dispatch) => {
  ...
  try {
    ...
    dispatch({
      type: types.LOAD_ADMIN_USER_FAILURE,
      payload: error.response.data,
    });
  }
};
...
export const getAllApplications = () => async (dispatch) => {
  try {
    ...
    dispatch({
      type: types.GET_ALL_ADMIN_APPLICATIONS_SUCCESS,
      payload: res.data,
    });
  } catch (error) {
    dispatch({
      type: types.GET_ALL_ADMIN_APPLICATIONS_FAILURE,
      payload: error.response.data,
    });
  }
};
...
export const getApplication = (id) => async (dispatch) => {
  try {
    ...
    dispatch({
      type: types.GET_ADMIN_APPLICATION_FAILURE,
      payload: error.response.data,
    });
  }
};
...
export const commentApplication = (id, comments) => async (dispatch) => {
  try {
    ...
    dispatch({
      type: types.COMMENT_APPLICATION_FAILURE,
      payload: error.response.data,
    });
  }
};
